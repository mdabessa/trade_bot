...
class DiscordLogger(Logger):
    def __init__(self,  webhook_url: str, avatar_url: str = None, webhook_username: str = 'Logger', fname: str = './log.txt') -> None:
        super().__init__(fname=fname)
        self.hook = Webhook(webhook_url, username=webhook_username, avatar_url=avatar_url)
